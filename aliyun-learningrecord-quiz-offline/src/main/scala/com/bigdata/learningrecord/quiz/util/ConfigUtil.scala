...
object ConfigUtil {
    ...
    def getConfig = {
        ...
        configProps.put(ConfigConstants.LOG_CONSUMERGROUP, "bigdata-streaming-learning-record-quiz-offline")
        // 设置日志服务的project
        ...
        //configProps.put(ConfigConstants.LOG_CONSUMER_BEGIN_POSITION, "1553872980")  //2018-12-31 13:09:10
        // 设置日志服务的消息反序列化方法
