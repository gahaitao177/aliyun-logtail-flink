...
object ConfigUtil {
    ...
    def getConfig = {
        ...
        configProps.put(ConfigConstants.LOG_CONSUMERGROUP, "bigdata-streaming-ml-trial-lesson-assigning-model")
        // 设置日志服务的project
        configProps.put(ConfigConstants.LOG_PROJECT, "trial-lesson-assigning")
        // 设置日志服务的Logstore
        configProps.put(ConfigConstants.LOG_LOGSTORE, "trial_lesson_assigning_model")
        // 设置消费日志服务起始位置
